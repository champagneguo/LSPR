...
public class SplineChart01View extends TouchView {
	...
	private LinkedHashMap<Double, Double> T;
	...
	public SplineChart01View(FragmentActivity fragmentActivity,
	...
	private void chartDataSet() {
		...
		SplineData dataSeries1 = new SplineData(" T值  ", T, (int) Color.rgb(54,
				148, 238));
	...
	private void chartRender() {
		...
		try {
			...
			// 坐标系
			// 数据轴最大值
			chart.getDataAxis().setAxisMax(1.4);
			chart.getDataAxis().setAxisMin(0.4);
			// 数据轴刻度间隔
