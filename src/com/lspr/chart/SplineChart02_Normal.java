...
public class SplineChart02_Normal extends TouchView {

	private String TAG = "SplineChart02_Normal";
	private SplineChart chart = new SplineChart();
	private LinkedHashMap<Double, Double> M_Normal = new LinkedHashMap<Double, Double>();
	...
	public SplineChart02_Normal(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		initView();
	}

	public SplineChart02_Normal(FragmentActivity fragmentActivity,
			LinkedHashMap<Double, Double> Hashmap, String Title_Second,
			HashMap<String, Double> mHashMap) {
		super(fragmentActivity);
		this.M_Normal = Hashmap;
	...
	private void chartDataSet() {
		...
		SplineData dataSeries1 = new SplineData(" M值  ", M_Normal,
